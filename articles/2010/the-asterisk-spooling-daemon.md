...
Summary: An informal code review and look at the Asterisk call file daemon (pbx_spool.so).
...
extreme depth.
  ...
  [Daemon Sketch]: {filename}/images/2010/daemon-sketch.png "Daemon Sketch"
